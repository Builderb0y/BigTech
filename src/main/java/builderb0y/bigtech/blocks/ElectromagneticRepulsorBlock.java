...
public class ElectromagneticRepulsorBlock extends FerromagneticRepulsorBlock {

	public static final MapCodec<ElectromagneticRepulsorBlock> CODEC = BigTechAutoCodec.callerMapCodec();
	...
	public ElectromagneticRepulsorBlock(Settings settings) {
		super(settings);
