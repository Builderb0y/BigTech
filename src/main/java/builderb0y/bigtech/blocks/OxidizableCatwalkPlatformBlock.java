...
public class OxidizableCatwalkPlatformBlock extends CatwalkPlatformBlock implements Oxidizable {
	...
	public static final MapCodec<OxidizableCatwalkPlatformBlock> CODEC = BigTechAutoCodec.callerMapCodec();
	...
	public OxidizableCatwalkPlatformBlock(Settings settings, OxidationLevel oxidation_level) {
		super(settings);
