...
import builderb0y.bigtech.blockEntities.TechnoCrafterBlockEntity;
import builderb0y.bigtech.codecs.BigTechAutoCodec;
import builderb0y.bigtech.util.WorldHelper;

public class TechnoCrafterBlock extends Block implements BlockEntityProvider {

	public static final MapCodec<TechnoCrafterBlock> CODEC = BigTechAutoCodec.callerMapCodec();
	...
	public TechnoCrafterBlock(Settings settings) {
		super(settings);
	}
