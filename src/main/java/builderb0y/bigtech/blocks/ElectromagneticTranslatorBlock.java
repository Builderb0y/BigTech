...
public class ElectromagneticTranslatorBlock extends FerromagneticTranslatorBlock {

	public static final MapCodec<ElectromagneticTranslatorBlock> CODEC = BigTechAutoCodec.callerMapCodec();
	...
	public ElectromagneticTranslatorBlock(Settings settings) {
		super(settings);
