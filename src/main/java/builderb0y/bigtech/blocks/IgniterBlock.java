...
public class IgniterBlock extends Block implements BlockEntityProvider {
	...
	*/
	...
	public static final MapCodec<IgniterBlock> CODEC = BigTechAutoCodec.callerMapCodec();
	...
	public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity, EntityCollisionHandler handler) {
		...
		if (world instanceof ServerWorld serverWorld) {
			IgniterBlockEntity igniter = WorldHelper.getBlockEntity(world, pos, IgniterBlockEntity.class);
			if (igniter != null) igniter.onEntityCollision(serverWorld, entity);
		}
	}
