...
public class DestroyerScreenHandler extends BigTechScreenHandler {
	...
	public DestroyerScreenHandler(@Nullable ScreenHandlerType<?> type, int syncId, Inventory inventory, PlayerInventory playerInventory) {
	...
	public DestroyerScreenHandler(int syncID, PlayerInventory playerInventory) {
		this(
