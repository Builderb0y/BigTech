...
public class ConductiveAnvilScreenHandler extends BigTechScreenHandler {
	...
	public ConductiveAnvilScreenHandler(@Nullable ScreenHandlerType<?> type, int syncId, Inventory inventory, Inventory playerInventory) {
	...
	public ConductiveAnvilScreenHandler(int syncId, Inventory playerInventory) {
