...
public class TripwireDataGenerator extends RedstoneTransceiverDataGenerator {

	public TripwireDataGenerator(BlockItem blockItem) {
		super(blockItem);
	}
		...
		context.writeToFile(
			...
			"""
			{
				...
				"textures": {
					...
					"body_top":    "bigtech:block/tripwire_top_bottom",
					"body_front":  "bigtech:block/tripwire_front",
					"body_side":   "bigtech:block/tripwire_side",
					"particle":    "bigtech:block/tripwire_side"
				},
				"elements": [
					{
						"from": [  0, 0,  0 ],
