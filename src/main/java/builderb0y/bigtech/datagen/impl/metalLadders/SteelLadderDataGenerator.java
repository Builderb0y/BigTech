...
public class SteelLadderDataGenerator extends MetalLadderDataGenerator {

	public SteelLadderDataGenerator(BlockItem blockItem) {
		super(blockItem);
	}
	...
	public void writeRecipes(DataGenContext context) {
		context.writeToFile(
			...
			.pattern("i i", "iii", "i i")
			.where('i', BigTechItemTags.STEEL_NUGGETS)
			.result(this.getId())
			.count(3)
			.toString()
		);
