...
public class IgniterBeamDataGenerator extends BasicBlockDataGenerator {

	public IgniterBeamDataGenerator(BlockItem blockItem) {
		super(blockItem);
	}
		...
		context.writeToFile(
			...
			"""
			{
				...
				"textures": {
					...
					"body_top":    "bigtech:block/igniter_beam_side",
					"body_front":  "bigtech:block/igniter_beam_front",
					"body_side":   "bigtech:block/igniter_beam_side",
					"particle":    "bigtech:block/igniter_beam_side"
				},
				"elements": [
					{
						"from": [  0, 0,  0 ],
	...
	public void writeRecipes(DataGenContext context) {
		context.writeToFile(
			...
			.where('i', FunctionalItems.IGNITER)
