...
public class IgniterDataGenerator extends BasicBlockDataGenerator {

	public IgniterDataGenerator(BlockItem blockItem) {
		super(blockItem);
	}
	...
	public void writeBlockModels(DataGenContext context) {
		context.writeToFile(
			...
			.blockTexture("front", BigTechMod.modID("igniter_front"))
			.blockTexture("side", BigTechMod.modID("igniter_side"))
			.blockTexture("top", BigTechMod.modID("igniter_top"))
		...
		context.writeToFile(
			...
			new RetexturedModelBuilder()
			.blockParent(Identifier.ofVanilla("orientable_with_bottom"))
			.blockTexture("front", BigTechMod.modID("igniter_front_lit"))
			.blockTexture("side", BigTechMod.modID("igniter_side"))
			.blockTexture("top", BigTechMod.modID("igniter_top_lit"))
			.blockTexture("bottom", Identifier.ofVanilla("smooth_stone"))
			.toString()
		);
	}
