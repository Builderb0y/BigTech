...
public class ComparatorCircuitDataGenerator extends RotatableCircuitDataGenerator {

	public ComparatorCircuitDataGenerator(Item item) {
		super(item);
	}
	...
	public void writeRecipes(DataGenContext context) {
		...
		context.writeToFile(
			...
			.group("bigtech:circuit_components")
			.category(CraftingRecipeCategory.REDSTONE)
			.ingredient(MaterialItems.SUBTRACTER_CIRCUIT)
			.result(this.getId())
			.toString()
		);
	}
