...
public class SourceCircuitDataGenerator extends BasicItemDataGenerator {

	public SourceCircuitDataGenerator(Item item) {
		super(item);
	}
		...
		context.writeToFile(
			...
			"""
			{
				"model": {
					...
					"model": "bigtech:item/source_circuit",
					"tints": [
						{
	...
	public void writeItemModels(DataGenContext context) {
		context.writeToFile(
			...
			"""
			{
				...
				"textures": {
					"layer0": "bigtech:item/source_circuit_base",
					"layer1": "bigtech:item/source_circuit_tint"
				}
			}"""
		);
	}
