...
public class NotGateCircuitDataGenerator extends RotatableCircuitDataGenerator {

	public NotGateCircuitDataGenerator(Item item) {
		super(item);
	}
	...
	public void writeRecipes(DataGenContext context) {
		context.writeToFile(
			...
			.ingredient(Items.REDSTONE_TORCH)
